    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_honbul"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewhbl badge badge-pill badge-success" data-toggle="modal" data-target="#view_honbul" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-edithbl badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_honbul" data-id="<?= $id; ?>"> Edit</span>
                                        <span class="btn-deletehbl badge badge-pill badge-danger" data-toggle="modal" data-target="#hapus_honbul" data-id="<?= $id; ?>">Delete</span>
                                    <?php } else { ?>
...
<!-- Modal add-->
<div class="modal fade" id="add_honbul" tabindex="-1" role="dialog" aria-labelledby="add_honbulLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('honbul/simpan_honbul'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_honbullabel">Upload Dokumen Honor Bulanan</h5>
...
<div class="modal fade" id="view_honbul" tabindex="-1" role="dialog" aria-labelledby="view_honbulLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_honbullabel">Download Dokumen Honor Bulanan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vkode_hbl" name="kode_hbl" value="" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        ...
                                        <div class="form-group">
                                            <label for="file_spm">File SPM</label>
...
<div class="modal fade" id="edit_honbul" tabindex="-1" role="dialog" aria-labelledby="edit_honbulLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('honbul/ubah_honbul'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="lpj_id" name="lpj_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_honbullabel">Edit Dokumen Honor Bulanan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                ...
                                <div class="form-group">
                                    <label>Kode Dokumen</label>
                                    <input type="text" class="form-control" id="ekode_hbl" name="kode_hbl" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<!-- modal hapus -->
<div class="modal fade" id="hapus_honbul" tabindex="-1" role="dialog" aria-labelledby="hapus_honbulLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="hapus_honbullabel">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="" action="<?= base_url('honbul/hapus_honbul'); ?>" method="post">
                        <div class="position-relative form-group">
                            <p>Apakah Anda Yakin ingin menghapus data <span style="color:red;font-weight:bold" id="txtid"></span> ?</p>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" id="dkode_hbl" name="dkode_hbl">
