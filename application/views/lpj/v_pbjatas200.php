    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_pbjatas200"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewpbjatas200 badge badge-pill badge-success" data-toggle="modal" data-target="#view_pbjatas200" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-editpbjatas200 badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_pbjatas200" data-id="<?= $id; ?>">Edit</span>
                                        <span class="btn-deletepbjatas200 badge badge-pill badge-danger" data-toggle="modal" data-target="#hapus_pbjatas200" data-id="<?= $id; ?>">Delete</span>
...
<!-- Modal add-->
<div class="modal fade" id="add_pbjatas200" tabindex="-1" role="dialog" aria-labelledby="add_pbjatas200Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('pbjatas200/simpan_pbjatas200'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_pbjatas200label">Upload Dokumen PBJ diatas 200 Juta</h5>
                        ...
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-auto">
                                        <div class="form-group">
                                            <label>Dokumen Lelang</label>
                                            <input name="file_lelang" type="file" class="form-control-file">
                                        </div>
                                        <div class="form-group">
...
<div class="modal fade" id="view_pbjatas200" tabindex="-1" role="dialog" aria-labelledby="view_pbjatas200Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_pbjatas200label">Download Dokumen PBJ diatas 200 Juta</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-auto">
                                        ...
                                        <div class="form-group">
                                            <label>File Dokumen Lelang</label>
                                            <a href="" target="_blank" id="vfile_lelang" name="file_lelang" class="btn btn-success btn-sm"><i class="fas fa-fw fa-download" placeholder="download"></i></a>
                                        </div>
                                        <div class="form-group">
...
<div class="modal fade" id="edit_pbjatas200" tabindex="-1" role="dialog" aria-labelledby="edit_pbjatas200Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('pbjatas200/ubah_pbjatas200'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="lpj_id" name="lpj_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_pbjatas200label">Edit Dokumen PBJ diatas 200 Juta</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-auto">
                                        <div class="form-group">
                                            <label>File Dokumen Lelang</label>
                                            <input id="file_lelang" name="file_lelang" type="file" class="form-control-file">
                                            <input type="text" class="form-control" id="efile_lelang" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>File Dokumen Karwas Kontrak</label>
...
<!-- modal hapus -->
<div class="modal fade" id="hapus_pbjatas200" tabindex="-1" role="dialog" aria-labelledby="hapus_pbjatas200Label" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="hapus_pbjatas200label">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form class="" action="<?= base_url('pbjatas200/hapus_pbjatas200'); ?>" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" id="dfile_lelang" name="dfile_lelang">
