    ...
    <div class="row">
        <div class="col-lg">
            ...
            if ($pilihan['is_upload'] == '1') { ?>
                <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#add_up"> Tambah Data</a>
            <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($pilihan['is_download'] == '1') { ?>
                                        <!-- 1 : Boleh -->
                                        <span class="btn-viewup badge badge-pill badge-success" data-toggle="modal" data-target="#view_up" data-id="<?= $id; ?>">View</span>
                                        <span class="btn-editup badge badge-pill badge-warning" data-toggle="modal" data-target="#edit_up" data-id="<?= $id; ?>">Edit</span>
                                        <span class="btn-deleteup badge badge-pill badge-danger" data-toggle="modal" data-target="#hapus_up" data-id="<?= $id; ?>">Delete</span>
...
<!-- Modal add-->
<div class="modal fade" id="add_up" tabindex="-1" role="dialog" aria-labelledby="add_upLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('up/simpan_up'); ?>" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add_uplabel">Upload Dokumen UP</h5>
...
<div class="modal fade" id="view_up" tabindex="-1" role="dialog" aria-labelledby="view_upLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="view_uplabel">Download Dokumen UP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vkode_up" name="kode_up" value="" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<div class="modal fade" id="edit_up" tabindex="-1" role="dialog" aria-labelledby="edit_upLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form action="<?= base_url('up/ubah_up'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" id="lpj_id" name="lpj_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit_uplabel">Edit Dokumen UP</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-auto">
                                ...
                                <div class="form-group">
                                    <label>Kode Dokumen</label>
                                    <input type="text" class="form-control" id="ekode_up" name="kode_up" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<!-- modal hapus -->
<div class="modal fade" id="hapus_up" tabindex="-1" role="dialog" aria-labelledby="hapus_upLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="hapus_uplabel">Perhatian!!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
